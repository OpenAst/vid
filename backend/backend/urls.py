...
from accounts.views import (
  ...
  csrf, LogoutView, ActivateUserView, ResendActivationEmailView, check_email, get_avatar_url, get_voice_note_url,
  get_message_attachment_url, google_auth_redirect,
  ...
  DirectConversationMessagesAPIView, DirectMessageReactionAPIView, DirectMessageVisibilityAPIView,
  UserDirectoryAPIView, NotificationListAPIView,
...
urlpatterns = [
    ...
    path('auth/users/resend_activation/', ResendActivationEmailView.as_view(), name='resend-activation'),
    ...
    path('auth/messages/attachment-url/', get_message_attachment_url, name='message_attachment_url'),
    ...
    path('auth/messages/conversations/<uuid:conversation_id>/messages/<uuid:message_id>/visibility/', DirectMessageVisibilityAPIView.as_view(), name='message-visibility'),
